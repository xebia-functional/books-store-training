...
public class Bookstore {
    ...
    public Bookstore(List<Book> books, List<User> users, Map<String, String> loans, Map<String, LocalDate> loanDate) {
        this.books = books;
        this.users = users;
        this.loans = loans;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(books, bookstore.books) && Objects.equals(users, bookstore.users) && Objects.equals(loans, bookstore.loans) && Objects.equals(loanDate, bookstore.loanDate);
    }
